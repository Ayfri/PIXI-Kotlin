...
open external class EventEmitter<EventTypes : String> {
	...
	open fun removeListener(event: EventTypes, fn: ListenerFn = definedExternally, context: Any = definedExternally, once: Boolean = definedExternally) : EventEmitter<EventTypes> /* this */
